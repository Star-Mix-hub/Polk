...
var js_close = document.querySelector(".close");
...
js_close.onclick = hideMenu;

//select 
var selectFace = document.querySelector(".select-fake");
var btn = document.querySelector(".dropdown__button");
var drobList = document.querySelector(".drobdown__list");
var drobItem = document.querySelectorAll(".drobdown__item");
var selectInput = document.querySelector(".select-input");
btn.addEventListener("click", function (e) {
  e.preventDefault();
  drobList.classList.toggle("drobdown__list-visible");
  drobItem.forEach(function (list) {
    list.addEventListener("click", function (e) {
      e.stopPropagation();
      btn.innerHTML = this.innerHTML;
      drobList.classList.remove("drobdown__list-visible");
...
//form 
var js_form = document.querySelector(".statement__form");
var btnForm = document.querySelector(".statement__btn");
btnForm.addEventListener("click", formSend);
function formSend(_x) {
  return _formSend.apply(this, arguments);
}
function _formSend() {
  _formSend = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(e) {
    var error, formData, responce;
    return regenerator.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          error = formValidate(js_form);
